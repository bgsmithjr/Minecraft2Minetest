...
minetest.register_tool("default:pick_titanium", {
	description = "Titanium Pickaxe",
	inventory_image = "default_tool_titaniumpick.png",
	tool_capabilities = {
		max_drop_level=1,
		groupcaps={
			cracky={times={[1]=5.00, [2]=2, [3]=1.20}, uses=20, maxlevel=3}
		}
	},
})
...
minetest.register_tool("default:shovel_titanium", {
	description = "Titanium Shovel",
	inventory_image = "default_tool_titaniumshovel.png",
	tool_capabilities = {
		max_drop_level=1,
		groupcaps={
			crumbly={times={[1]=1.50, [2]=0.90, [3]=0.90}, uses=20, maxlevel=3}
		}
	},
})
...
minetest.register_tool("default:axe_titanium", {
	description = "Titanium Axe",
	inventory_image = "default_tool_titaniumaxe.png",
	tool_capabilities = {
		max_drop_level=1,
		groupcaps={
			choppy={times={[1]=3.00, [2]=2.2, [3]=1.40}, uses=20, maxlevel=3},
			fleshy={times={[2]=1.10, [3]=0.50}, uses=60, maxlevel=1}
		}
	},
})
...
minetest.register_tool("default:sword_titanium", {
	description = "Titanium Sword",
	inventory_image = "default_tool_titaniumsword.png",
	tool_capabilities = {
		full_punch_interval = 1.0,
		max_drop_level=1,
		groupcaps={
			fleshy={times={[1]=3.00, [2]=1.4, [3]=0.8}, uses=20, maxlevel=3},
			snappy={times={[2]=0.70, [3]=0.30}, uses=40, maxlevel=1},
			choppy={times={[3]=0.70}, uses=40, maxlevel=0}
		}
	}
...
minetest.register_craft({
	output = 'default:sandstone_brick',
	recipe = {
...
minetest.register_craft({
	output = 'default:radio',
	recipe = {
		{'default:magic_dust','default:magic_dust'},
...
minetest.register_craft({
	output = 'default:pick_titanium',
	recipe = {
		{'default:stone_with_titanium', 'default:stone_with_titanium', 'default:stone_with_titanium'},
		{'', 'default:stick', ''},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_craft({
	output = 'default:shovel_titanium',
	recipe = {
		{'default:stone_with_titanium'},
		{'default:stick'},
		{'default:stick'},
	}
})
...
minetest.register_craft({
	output = 'default:axe_titanium',
	recipe = {
		{'default:stone_with_titanium', 'default:stone_with_titanium'},
		{'default:stone_with_titanium', 'default:stick'},
		{'', 'default:stick'},
	}
})
...
minetest.register_node("default:building_stone", {
	description = "Building Stone",
	tile_images = {"default_building_stone.png"},
	is_ground_content = true,
	groups = {cracky=3},
	drop = 'default:cobble',
	legacy_mineral = true,
...
minetest.register_node("default:stone_with_titanium", {
	...
	tile_images = {"default_stone.png^default_mineral_titanium.png"},
	is_ground_content = true,
	groups = {cracky=3},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("default:stone_with_magic_powder", {
	description = "Stone with magic_powder",
	tile_images = {"default_stone.png^default_mineral_magic_powder.png"},
	is_ground_content = true,
	groups = {cracky=3},
	drop = 'craft "default:magic_powder" 4',
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:snowflakes", {
	description = "Snowflakes",
	tile_images = {"default_snowflakes.png"},
	is_ground_content = true,
	groups = {crumbly=3},
	sounds = default.node_sound_dirt_defaults(),
})
...
minetest.register_node("default:sandstone_brick", {
	...
	tile_images = {"default_sandstone_brick.png"},
	is_ground_content = true,
	groups = {crumbly=2,cracky=2},
	drop = 'default:sand',
	sounds = default.node_sound_stone_defaults(),
...
minetest.register_node("default:radio", {
	description = "Radio",
	tile_images = {"default_wood.png", "default_wood.png", "default_bookshelf.png"},
	is_ground_content = true,
	groups = {snappy=2,choppy=3,oddly_breakable_by_hand=2},
...
minetest.register_node("default:titaniumblock", {
	...
	tile_images = {"default_titanium_block.png"},
	is_ground_content = true,
	groups = {snappy=1,bendy=2},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_craftitem("default:magic_powder", {
	description = "magic_powder",
	inventory_image = "default_magic_powder.png",
})
...
-- Creative inventory
--
minetest.add_to_creative_inventory('default:magic_powder')
minetest.add_to_creative_inventory('default:radio')
minetest.add_to_creative_inventory('default:titaniumblock')
minetest.add_to_creative_inventory('default:pick_titanium')
...
minetest.add_to_creative_inventory('default:axe_titanium')
minetest.add_to_creative_inventory('default:shovel_titanium')
...
minetest.add_to_creative_inventory('default:sandstone_brick')
